# MODELAMIENTO E IMPLEMENTACIÓN DE SERENATA ALEATORIA
...
Se debe realizar el modelado y la implementación de una simulación aleatoria de una serenata, donde se tenga la flexibilidad de representarse a través de cualquier tipo de instrumento.
